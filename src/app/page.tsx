...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
            ...
            {/* About Section */}
            <StandardSection id="about" useFadeIn={true} fadeInDelay={200}>
            ...
            {/* Camping Section */}
            <StandardSection id="camping" bgColor="green-50" useFadeIn={true} fadeInDelay={400}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
            ...
            {/* Wonder Yurt Section */}
            <StandardSection id="yurt" useFadeIn={true} fadeInDelay={600}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        <div>
            ...
            <StandardSection bgColor="gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
